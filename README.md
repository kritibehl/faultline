...
- Latest report: `reports/latest/benchmark_summary.json`
- Tests: `make test`
- Demo: `make demo`
...
*Generated by CI on every run — [`reports/latest/benchmark_summary.json`](reports/latest/benchmark_summary.json)*
